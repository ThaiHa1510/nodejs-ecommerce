(function($) {
    ...
    $("#submitReview").click(function(e){
        e.preventDefault();
        console.log("chay clickl");
        let fullName=$('#fullName_review').val();
        let email=$('#email_review').val();
        let scope=$('.ps-product__review .br-selected').length;
        let content=$("#textarea_review").val();
        let url=$("#form_reviews").attr('action');
